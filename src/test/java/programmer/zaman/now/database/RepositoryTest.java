...
public class RepositoryTest {
    ...
    @Test
    void testInsert() {
        Comment comment = new Comment("nafil@gagah.com", "yareyare");
    ...
    void testFindById() {
        ...
        Comment notFound = commentRepository.findById(66666);
    ...
    @Test
    void tesFindByEmail() {
        List<Comment> comments = commentRepository.findAllByEmail("salah@gagah.com");
        System.out.println(comments.size());
    }
